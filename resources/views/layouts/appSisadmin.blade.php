        ...
        <div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav">
                ...
                <li class="nav-item dropdown"><a class="dropdown-item" href="{{ route('logout') }}"
                    ...
                    document.getElementById('logout-form').submit();"><i class="icon icon-share-alt"></i> <span class="text">{{ __('Sair do Sistema') }}</span></a></li-->
            </ul>           
        </div>
        ...
        <div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> oficina Auto nelo</a>
            <ul>
                ...
                <li class="submenu"><a href="#"><i class="icon icon-tint"></i> <span>Produto</span></a>
                    <ul>
                        <li> <a href="/categoria"><i class="icon-plus"></i>Categoria</a></li>
                        <li> <a href="/categoria-listar/2"></i> Eliminar Categoria</a></li>
                        <li><a href="#"><i class="icon-plus"></i>Cadastrar Produto</a></li>
                        <li><a href="">Ver todos os Produto</a></li>
                ...
                <li class="submenu"> <a href="#"><i class="icon icon-file"></i> <span>Vendas</span></a>
                    <ul>
                        ...
                        <li><a href="#">Ver todas as vendas</a></li>
